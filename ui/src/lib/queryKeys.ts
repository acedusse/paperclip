...
export const queryKeys = {
  ...
  approvals: {
    ...
    triage: (companyId: string) => ["approval-triage", companyId] as const,
  },
  access: {
  ...
  companyPreflight: (companyId: string) => ["company-preflight", companyId] as const,
  healthSentinel: (companyId: string) => ["health-sentinel", companyId] as const,
