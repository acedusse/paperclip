/**
 * FILE: packages/adapter-utils/src/sandbox-install-command.test.ts
 * ABOUT: sandbox-install-command.test.ts (src module).
 *
 * SECTIONS:
 *   [TAG: module] - sandbox-install-command.test.ts (src module).
 */
// ==========================================
// [META: module]
// INTENT: sandbox-install-command.test.ts (src module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/adapter-utils/src/sandbox-install-command.test.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
