/**
 * FILE: packages/db/src/schema/plugin_database.ts
 * ABOUT: plugin_database.ts (schema module).
 *
 * SECTIONS:
 *   [TAG: module] - plugin_database.ts (schema module).
 */
// ==========================================
// [META: module]
// INTENT: plugin_database.ts (schema module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/db/src/schema/plugin_database.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
import {
  pgTable,
