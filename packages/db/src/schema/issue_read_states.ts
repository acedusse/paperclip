/**
 * FILE: packages/db/src/schema/issue_read_states.ts
 * ABOUT: issue_read_states.ts (schema module).
 *
 * SECTIONS:
 *   [TAG: module] - issue_read_states.ts (schema module).
 */
// ==========================================
// [META: module]
// INTENT: issue_read_states.ts (schema module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/db/src/schema/issue_read_states.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
