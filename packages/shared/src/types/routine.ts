/**
 * FILE: packages/shared/src/types/routine.ts
 * ABOUT: routine.ts (types module).
 *
 * SECTIONS:
 *   [TAG: module] - routine.ts (types module).
 */
// ==========================================
// [META: module]
// INTENT: routine.ts (types module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/shared/src/types/routine.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
import type {
  IssueOriginKind,
