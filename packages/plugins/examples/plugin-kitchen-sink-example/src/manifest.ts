/**
 * FILE: packages/plugins/examples/plugin-kitchen-sink-example/src/manifest.ts
...
// JSON_FLOW: {"file": "packages/plugins/examples/plugin-kitchen-sink-example/src/manifest.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
