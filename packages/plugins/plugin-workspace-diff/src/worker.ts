/**
 * FILE: packages/plugins/plugin-workspace-diff/src/worker.ts
...
// JSON_FLOW: {"file": "packages/plugins/plugin-workspace-diff/src/worker.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
