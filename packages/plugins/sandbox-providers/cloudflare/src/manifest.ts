/**
 * FILE: packages/plugins/sandbox-providers/cloudflare/src/manifest.ts
...
// JSON_FLOW: {"file": "packages/plugins/sandbox-providers/cloudflare/src/manifest.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
