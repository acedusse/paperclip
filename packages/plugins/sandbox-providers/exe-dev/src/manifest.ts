/**
 * FILE: packages/plugins/sandbox-providers/exe-dev/src/manifest.ts
...
// JSON_FLOW: {"file": "packages/plugins/sandbox-providers/exe-dev/src/manifest.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
