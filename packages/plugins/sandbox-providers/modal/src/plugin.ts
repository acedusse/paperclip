/**
 * FILE: packages/plugins/sandbox-providers/modal/src/plugin.ts
...
// JSON_FLOW: {"file": "packages/plugins/sandbox-providers/modal/src/plugin.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
import {
  ModalClient,
