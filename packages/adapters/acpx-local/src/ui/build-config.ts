/**
 * FILE: packages/adapters/acpx-local/src/ui/build-config.ts
...
// JSON_FLOW: {"file": "packages/adapters/acpx-local/src/ui/build-config.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
