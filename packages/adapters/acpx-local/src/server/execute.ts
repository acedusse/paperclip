/**
 * FILE: packages/adapters/acpx-local/src/server/execute.ts
...
// JSON_FLOW: {"file": "packages/adapters/acpx-local/src/server/execute.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
