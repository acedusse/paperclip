/**
 * FILE: packages/adapters/grok-local/src/server/skills.ts
...
// JSON_FLOW: {"file": "packages/adapters/grok-local/src/server/skills.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
