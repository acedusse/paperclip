/**
 * FILE: packages/adapters/grok-local/src/ui/parse-stdout.ts
...
// JSON_FLOW: {"file": "packages/adapters/grok-local/src/ui/parse-stdout.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
