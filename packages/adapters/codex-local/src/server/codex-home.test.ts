/**
 * FILE: packages/adapters/codex-local/src/server/codex-home.test.ts
 * ABOUT: codex-home.test.ts (server module).
 *
 * SECTIONS:
 *   [TAG: module] - codex-home.test.ts (server module).
 */
// ==========================================
// [META: module]
// INTENT: codex-home.test.ts (server module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/adapters/codex-local/src/server/codex-home.test.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
