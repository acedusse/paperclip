/**
 * FILE: packages/adapters/codex-local/src/ui/parse-stdout.ts
...
// JSON_FLOW: {"file": "packages/adapters/codex-local/src/ui/parse-stdout.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
