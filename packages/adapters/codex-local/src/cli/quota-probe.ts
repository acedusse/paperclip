/**
 * FILE: packages/adapters/codex-local/src/cli/quota-probe.ts
...
// JSON_FLOW: {"file": "packages/adapters/codex-local/src/cli/quota-probe.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
#!/usr/bin/env node
