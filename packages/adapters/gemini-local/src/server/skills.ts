/**
 * FILE: packages/adapters/gemini-local/src/server/skills.ts
...
// JSON_FLOW: {"file": "packages/adapters/gemini-local/src/server/skills.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
