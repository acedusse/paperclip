/**
 * FILE: packages/adapters/gemini-local/src/server/index.ts
...
// JSON_FLOW: {"file": "packages/adapters/gemini-local/src/server/index.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
