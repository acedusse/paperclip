/**
 * FILE: packages/adapters/gemini-local/src/ui/build-config.ts
...
// JSON_FLOW: {"file": "packages/adapters/gemini-local/src/ui/build-config.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
