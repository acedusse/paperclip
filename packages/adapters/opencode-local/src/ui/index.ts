/**
 * FILE: packages/adapters/opencode-local/src/ui/index.ts
...
// JSON_FLOW: {"file": "packages/adapters/opencode-local/src/ui/index.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
