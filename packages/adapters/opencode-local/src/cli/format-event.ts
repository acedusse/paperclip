/**
 * FILE: packages/adapters/opencode-local/src/cli/format-event.ts
...
// JSON_FLOW: {"file": "packages/adapters/opencode-local/src/cli/format-event.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
