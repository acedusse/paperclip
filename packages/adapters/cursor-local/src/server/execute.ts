/**
 * FILE: packages/adapters/cursor-local/src/server/execute.ts
...
// JSON_FLOW: {"file": "packages/adapters/cursor-local/src/server/execute.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
