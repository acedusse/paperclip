/**
 * FILE: packages/adapters/cursor-local/vitest.config.ts
 * ABOUT: vitest.config.ts (cursor-local module).
 *
 * SECTIONS:
 *   [TAG: module] - vitest.config.ts (cursor-local module).
 */
// ==========================================
// [META: module]
// INTENT: vitest.config.ts (cursor-local module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/adapters/cursor-local/vitest.config.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
