/**
 * FILE: packages/adapters/pi-local/src/ui/parse-stdout.ts
...
// JSON_FLOW: {"file": "packages/adapters/pi-local/src/ui/parse-stdout.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
