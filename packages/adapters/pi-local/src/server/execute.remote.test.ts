/**
 * FILE: packages/adapters/pi-local/src/server/execute.remote.test.ts
...
// JSON_FLOW: {"file": "packages/adapters/pi-local/src/server/execute.remote.test.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
