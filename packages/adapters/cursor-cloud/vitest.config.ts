/**
 * FILE: packages/adapters/cursor-cloud/vitest.config.ts
 * ABOUT: vitest.config.ts (cursor-cloud module).
 *
 * SECTIONS:
 *   [TAG: module] - vitest.config.ts (cursor-cloud module).
 */
// ==========================================
// [META: module]
// INTENT: vitest.config.ts (cursor-cloud module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "packages/adapters/cursor-cloud/vitest.config.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
