/**
 * FILE: packages/adapters/cursor-cloud/src/ui/build-config.ts
...
// JSON_FLOW: {"file": "packages/adapters/cursor-cloud/src/ui/build-config.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
