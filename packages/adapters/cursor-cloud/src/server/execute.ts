/**
 * FILE: packages/adapters/cursor-cloud/src/server/execute.ts
...
// JSON_FLOW: {"file": "packages/adapters/cursor-cloud/src/server/execute.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
