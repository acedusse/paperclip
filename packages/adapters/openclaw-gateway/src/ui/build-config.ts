/**
 * FILE: packages/adapters/openclaw-gateway/src/ui/build-config.ts
...
// JSON_FLOW: {"file": "packages/adapters/openclaw-gateway/src/ui/build-config.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
