...
Expected: a new file `packages/db/src/migrations/0111_combo05_review_cockpit.sql` (name suffix may differ) creating both tables, plus an updated `meta/_journal.json`. Confirm the number is `0111`.
