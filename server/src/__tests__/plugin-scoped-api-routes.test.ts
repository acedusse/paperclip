/**
 * FILE: server/src/__tests__/plugin-scoped-api-routes.test.ts
 * ABOUT: plugin-scoped-api-routes.test.ts (__tests__ module).
 *
 * SECTIONS:
 *   [TAG: module] - plugin-scoped-api-routes.test.ts (__tests__ module).
 */
// ==========================================
// [META: module]
// INTENT: plugin-scoped-api-routes.test.ts (__tests__ module).
// PSEUDOCODE: 1. Load dependencies. 2. Define module members. 3. Export public API.
// JSON_FLOW: {"file": "server/src/__tests__/plugin-scoped-api-routes.test.ts", "imports": "see code", "exports": "see code"}
// ==========================================
// [START: module]
